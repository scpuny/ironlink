...
const messages: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'language': '语言',
    'proxy_port': '代理端口',
    'proxy_port_desc': 'IronLink 代理服务器监听端口',
    'proxy_port_stop_hint': '需先停止代理后才能修改端口',
    'start_minimized': '启动时最小化',
    'start_minimized_desc': '启动 IronLink 时最小化到托盘',
    'minimize_to_tray': '关闭时最小化到托盘',
    'minimize_to_tray_desc': '关闭窗口时最小化到托盘而非退出',
    'config_injection_toggle': '配置注入开关',
    'config_injection_toggle_desc': '启用时自动修改下游应用的配置文件指向 IronLink',
    'data_management': '数据管理',
    'export_config': '导出配置',
    'export_config_desc': '导出所有供应商和应用配置为 JSON 文件',
    'import_config': '导入配置',
    'import_config_desc': '从 JSON 文件导入配置',
    'import_success': '导入成功: {sections}',
    ...
    'view_config': '查看配置',
    'current_config': '当前配置',
    'config_file_empty': '配置文件为空',
    'error_reading_config': '读取配置文件失败',
    ...
    'protocol': '协议',
    'config_dir': '应用配置目录',
    'config_dir_placeholder': '留空则使用默认位置（如 ~/.codex）',
    'config_dir_desc': '覆盖应用配置文件的所在目录，仅 <codex_toml 类型生效>',
    'browse': '浏览',
    'backup_enabled': '写入前备份',
    'backup_enabled_desc': '修改配置文件前自动备份，禁用时恢复',
    'inject_fields': '注入字段',
    'inject_fields_desc': '选择要注入到配置文件的字段，不选则注入全部',
    'inject_field_model': '默认模型',
    'inject_field_reasoning': '推理努力度',
    'inject_field_catalog': '模型目录',
    'inject_field_providers': '供应商配置',
